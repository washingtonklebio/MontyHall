<template>
    <div class="door-area">
        <div class="door-frame" v-bind:class="{ selected: selected && !open }">
            <Gift v-if="open && hasGift"/>
        </div>
        <div class="door" v-bind:class="{ open }" @click="selected = !selected">
            <div class="number" v-bind:class="{ selected }">{{ number }}</div>
            <div class="knob" v-bind:class="{ selected }" @click.stop="open = true"></div>
        </div>
    </div>
</template>
